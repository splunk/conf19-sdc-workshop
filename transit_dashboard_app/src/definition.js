...
export default {
    dataSources: {
        num_agencies_search: {
            options: {
                query: `| from index:main where source="agencies_with_coverage_json_b2" | stats dc('id') as numAgencies`,
                queryParameters: {
                    earliest: '0',
                    latest: 'now',
                },
        ...
        num_routes_search: {
            options: {
                query: `| from index:main where source="arrivals_and_departures_json_b2" | stats dc('data.entry.stopId') as numStops`,
                queryParameters: {
                    earliest: '0',
                    latest: 'now',
                },
        ...
        num_stops_search: {
            options: {
                query: `| from index:main where source="arrivals_and_departures_json_b2" | stats dc('data.references.routes{}.id') as numRoutes`,
                queryParameters: {
                    earliest: '0',
                    latest: 'now',
                },
        ...
        status_search: {
            options: {
                query: `| from index:main where source="arrivals_and_departures_json_b2" | eval tripStatus='data.entry.arrivalsAndDepartures{}.tripStatus.status' | stats count(tripStatus) by tripStatus`,
                queryParameters: {
                    earliest: '0',
                    latest: 'now',
                },
